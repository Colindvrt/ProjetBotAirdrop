...
try:
    ...
    from API.paradex_api import ParadexAPI
    from API.lighter_api import LighterAPI
    from API.extended_api import ExtendedAPI

except ImportError:
    print("ERREUR: Un ou plusieurs fichiers API sont manquants.")
    # ... (classes factices) ...
...
class BotPage(ttk.Frame):
    ...
    def test_api_connection(self, platform):
        ...
        try:
            ...
            if platform == "hyperliquid":
                ...
                balance = trader_object.get_account_balance() # <--- APPEL RÉEL
    ...
    def start_bot_logic(self):
        ...
        try:
            ...
            # --- DÉBUT DE LA LOGIQUE DE TRADING (SIMULÉE) ---
    ...
    def after_safe(self, func, *args, **kwargs):
        ...
        if self.winfo_exists():
            # Utilise lambda pour que 'func' soit appelé avec les bons arguments
